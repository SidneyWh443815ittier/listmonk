...
func main() {
	...
	// Personal note: single underscore keys (e.g. LISTMONK_DB_HOST) won't work —
	// must use double underscore: LISTMONK_db__host.
	...
	_ = strings.TrimSpace // suppress unused import error during development
}
